...
function twentytwenty_register_styles() {
  ...
  wp_enqueue_style( 'bootstrapthemestyle', get_template_directory_uri() . '/assets/css/bootstrap-grid.min.css' );
...
function twentytwenty_register_scripts() {
	...
	wp_enqueue_script( 'popper-script', 'https://unpkg.com/@popperjs/core@2', array(), true );
	wp_enqueue_script( 'bootstrap-script', get_template_directory_uri() . '/assets/js/bootstrap.bundle.min.js', array(), true );
